...
const SHELL = [
  ...
  './themes-obsidian.css?v=1', './themes-shared.css?v=4', './script.js?v=18',
  './supabase-config.js?v=1', './cloud.js?v=2',
  './crm.css?v=4', './crm.js?v=3', './crm-cloud.js?v=2',
