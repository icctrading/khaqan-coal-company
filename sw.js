...
const SHELL = [
  ...
  './themes-obsidian.css?v=1', './themes-shared.css?v=4', './script.js?v=20',
  './supabase-config.js?v=1', './cloud.js?v=5',
  './crm.css?v=8', './crm.js?v=6', './crm-cloud.js?v=5',
