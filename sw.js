...
const SHELL = [
  ...
  './themes-obsidian.css?v=1', './themes-shared.css?v=7', './script.js?v=29',
  './supabase-config.js?v=1', './cloud.js?v=10',
  './crm.css?v=10', './crm.js?v=11', './crm-cloud.js?v=10',
