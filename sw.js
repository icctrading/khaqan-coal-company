...
const SHELL = [
  ...
  './themes-obsidian.css?v=1', './themes-shared.css?v=7', './script.js?v=24',
  './supabase-config.js?v=1', './cloud.js?v=8',
  './crm.css?v=10', './crm.js?v=9', './crm-cloud.js?v=8',
