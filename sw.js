...
const SHELL = [
  ...
  './themes-obsidian.css?v=1', './themes-shared.css?v=7', './script.js?v=23',
  './supabase-config.js?v=1', './cloud.js?v=7',
  './crm.css?v=9', './crm.js?v=8', './crm-cloud.js?v=7',
